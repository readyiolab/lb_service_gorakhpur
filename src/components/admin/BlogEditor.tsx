...
import { blogEditorSchema, BlogEditorFormValues, blogApi, createFormData, BlogSite } from '@/lib/api/forms';
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          {site === 'lb_services' ? 'LB Services' : site === 'clean_expert' ? 'Clean Expert' : 'LB Interiors'} - {mode === 'create' ? 'Create a new blog post' : 'Edit existing blog post'}
        </p>
      </div>
