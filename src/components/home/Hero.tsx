...
const Hero = () => {
  return (
    <section className="relative min-h-[500px] sm:min-h-[600px] lg:min-h-[700px] flex items-center">
      ...
      <div className="absolute inset-0 z-0 aspect-video md:aspect-auto">
        <img
          src="/hero.webp"
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 pt-16 sm:pt-20 lg:pt-24 pb-8 sm:pb-12">
        <div className="max-w-2xl min-h-[300px] sm:min-h-[400px]">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 sm:mb-6 leading-tight min-h-[1.2em]">
            Fast & Reliable{" "}
            <span className="text-orange-500">Home Services</span>{" "}
            at Your Doorstep
          </h1>
          
          <p className="text-base sm:text-lg md:text-xl text-gray-200 mb-6 sm:mb-8 leading-relaxed min-h-[3em]">
